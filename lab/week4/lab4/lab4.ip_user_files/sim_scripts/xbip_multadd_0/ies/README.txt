...
#
# Generated by export_simulation on Tue Mar 31 14:45:16 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './xbip_multadd_0.sh' script.

./xbip_multadd_0.sh -reset_run
...
./xbip_multadd_0.sh -noclean_files

For more information on the script, please type './xbip_multadd_0.sh -help'.
