...
#
# Generated by export_simulation on Tue Mar 31 14:44:12 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './floating_point_0.sh' script.

./floating_point_0.sh -reset_run
...
./floating_point_0.sh -noclean_files

For more information on the script, please type './floating_point_0.sh -help'.
