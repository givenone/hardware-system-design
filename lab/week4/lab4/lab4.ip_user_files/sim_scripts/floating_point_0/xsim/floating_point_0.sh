...
#
# Generated by Vivado on Tue Mar 31 14:44:12 +0900 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_9 -L axi_utils_v2_0_5 -L xbip_pipe_v3_0_5 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_5 -L xbip_dsp48_multadd_v3_0_5 -L xbip_bram18k_v3_0_5 -L mult_gen_v12_0_14 -L floating_point_v7_1_7 -L xil_defaultlib -L secureip -L xpm --snapshot floating_point_0 xil_defaultlib.floating_point_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim floating_point_0 -key {Behavioral:sim_1:Functional:floating_point_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb floating_point_0.wdb xsim.dir)
